...
yum install nginx -y
echo "\e[35m Removing Old Contents\e[0m"
rm -rf /usr/share/nginx/html/*
echo "\e[35m Downloading frontend\e[0m"
curl -o /tmp/frontend.zip https://roboshop-artifacts.s3.amazonaws.com/frontend.zip
echo "\e[35m Extracting frontend\e[0m"
cd /usr/share/nginx/html
unzip /tmp/frontend.zip
echo "\e[35m Copying into roboshop conf\e[0m"
cp configs/nginx-roboshop.conf /etc/nginx/default.d/roboshop.conf
echo "\e[35m Enabling Nginx\e[0m"
systemctl enable nginx
echo "\e[35m Starting Nginx\e[0m"
